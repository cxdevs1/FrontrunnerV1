...
export default function Home() {
  ...
  const generateShareText = (result: AnalysisResult) => {
    const date = new Date().toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' });
    return `INDEX ADDITION ANALYSIS
${result.ticker} | ${result.indexTarget}
${date}

PRESSURE SCORE: ${result.pressureScoreDisplay}
INTENSITY: ${result.intensity}
SHARES TO BUY: ${result.requiredSharesDisplay}
RELATIVE VOLUME: ${result.relativeVolumeDisplay}
ALGO STATUS: ${result.isAlgoActive ? "CAUTION - Front-running detected" : "CLEAR - Normal activity"}

RECOMMENDATION: ${result.action}

Generated by Index Inclusion Sniper`;
  };
  ...
  const handleCopyToClipboard = async () => {
    ...
    setCopied(true);
    toast({ title: "Copied to clipboard", description: "Analysis summary ready to paste" });
    setTimeout(() => {
      setCopied(false);
  ...
  const handleDownloadReport = () => {
    ...
    a.href = url;
    a.download = `${analysisResult.ticker}_analysis_${new Date().toISOString().split('T')[0]}.txt`;
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
    URL.revokeObjectURL(url);
    toast({ title: "Report downloaded", description: `${analysisResult.ticker} analysis saved` });
    setShowShareMenu(false);
  };
